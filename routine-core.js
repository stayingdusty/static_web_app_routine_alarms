...
export function initialData() {
  ...
  return {appVersion:'1.0.0',schemaVersion:1,routines:[r],activeRoutineId:r.id,preferences:{sound:'chime',volume:.7},keys:{next:'KeyN',previous:'KeyP',delay:'KeyS',silence:'KeyD'},runtime:null};
}
